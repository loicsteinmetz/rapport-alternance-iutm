...
During this year of apprenticeship, I was integrated in \textit{Efluid} company, an UEM's subsidiary based in Metz which provides a software package solution covering all requirements of electricity, gas and water stakeholders. I was integrated in the department in charge of the consumption management domain.\\

\textit{Efluid} allows one main programming language, \textit{Java}. Besides this language, SQL is also required in order to handle database operations. When I joined the company, I had already worked with these languages which facilitated my primary integration in the general \textit{Efluid}'s workflow.\\
